...
export function RevenueChartSkeleton() {
  return (
    <div className={`${shimmer} relative w-full overflow-hidden md:col-span-4`}>
      <div className="mb-4 h-8 w-36 rounded-md bg-gray-400" />
      <div className="rounded-xl bg-gray-400 p-4">
...
export function InvoiceSkeleton() {
  return (
    <div className="flex flex-row items-center justify-between border-b border-gray-400 py-4">
...
export function LatestInvoicesSkeleton() {
  return (
    ...
    >
      <div className="mb-4 h-8 w-36 rounded-md bg-gray-400" />
      <div className="flex grow flex-col justify-between rounded-xl bg-gray-400 p-4">
